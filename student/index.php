              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Home <span><img src="images/down-arrow.png" alt="" /></span></a>
                  <ul class="dropdown-menu newsfeed-home">
                    ...
                    <li><a href="index-registeradmin.html">sign in</a></li>
                  </ul>
              </li>
              <li class="dropdown">
    	...
    	<div class="container">
            ...
            <div class="contact-us">
            	<div class="row">
                  ...
                  <div class="reach"><span class="phone-icon"><i class="icon ion-android-call"></i></span><p>8848126604</p></div>
                  <div class="reach"><span class="phone-icon"><i class="icon ion-email"></i></span><p>sharewithazif@gmail.com</p></div>
                  <div class="reach"><span class="phone-icon"><i class="icon ion-ios-location"></i></span><p>Mes College Vattappara</p></div>
