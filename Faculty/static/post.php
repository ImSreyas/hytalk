...
mysqli_query($conn, "insert into feed set user_id='$FacId', user_type='faculty', caption='$caption', article='$text', image='$image_fileDestination_new', video='$video_fileDestination_new'");
}
...
<div class="main-post-container">
    <form method="post" action="" enctype="multipart/form-data">
        <div class="first-row">
        <img src="../<?php echo $FacImage; ?>" alt="" class="profile-photo-md" />
