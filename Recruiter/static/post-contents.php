...
if(isset($_POST['comment-btn'])){
    ...
    mysqli_query($conn, "insert into comment set comment='$comment_content', post_id='$post_id_', commenter_id='$rec_Id', post_owner_id='$post_owner', commenter_type='recruiter'");
}
