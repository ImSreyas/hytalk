                  ...
                  <form name="registration_form" id='registration_form' class="form-inline">
                    ...
                    <div class="row">
                        <div class="form-group col-xs-6">
                            ...
                            <input id="email" class="form-control input-group-lg" type="text" name="email" title="Enter your email" placeholder="Email"/>
                          </div>
                          <div class="form-group col-xs-6">
                            <label for="mobile n.o" class="sr-only">Mobile n.o</label>
                            <input id="mobile n.o" class="form-control input-group-lg" type="text" name="mobile n.o" title="Enter your mob n.o" placeholder="Mob n.o"/>
                          </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="Designation" class="form-control input-group-lg reg_name" type="text" name="Designation" title="Enter your designation" placeholder="Your Designation"/>
                      </div>
                      <div class="form-group col-xs-6">
                        ...
                        <select class="form-control" id="country">
                          ...
                          <option value="ALA">Physics</option>
                          <option value="ALB">Mathematics</option>
                          <option value="DZA">Economics</option>
                          <option value="ASM">Chemistry</option>
                          <option value="AND">History</option>
                          <option value="AGO">Commerce</option>
